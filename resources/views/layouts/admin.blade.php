...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center my-3" href="{{route('admin.index')}}">
            ...
            <!-- Nav Item - Pages Collapse Menu - Management of Posts-->
            @can('posts')
                <li class="nav-item">
                    ...
                    <div id="collapsePosts" class="collapse" aria-labelledby="headingPosts" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Posts Management</h6>
                                <a class="collapse-item" href="{{route('admin.posts.index')}}">Listing</a>

                            @can('create', App\Models\Post::class)
                                <a class="collapse-item" href="{{route('admin.posts.add')}}">Add a post</a>
                            @endcan
                            ...
                            @can('postsOfTrashedUsers', App\Models\Post::class)
                                <a class="collapse-item" href="{{route('admin.posts.postsOfTrashedUsers')}}">Posts of trashed Users</a>
                            @endcan
            ...
            <!-- Nav Item - Utilities Collapse Menu - Management of users's Groups-->
            @can('groups')
                <li class="nav-item">
                    ...
                    <div id="collapseGroups" class="collapse" aria-labelledby="headingGroups"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Groups Management</h6>
                            <a class="collapse-item" href="{{route('admin.groups.index')}}">Listing</a>

                            @can('create', App\Models\Group::class)
                            <a class="collapse-item" href="{{route('admin.groups.add')}}">Add a group</a>
                            @endcan
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="CollapseUsers" class="collapse" aria-labelledby="headingUsers"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="{{route('admin.users.index')}}">Listing</a>

                            @can('create', App\Models\User::class)
                            <a class="collapse-item" href="{{route('admin.users.add')}}">Add an user</a>
                            @endcan

                            @can('trash', App\Models\User::class)
                            <a class="collapse-item" href="{{route('admin.users.trash')}}">Trash</a>
                            @endcan
                        </div>
                    </div>
                </li>
