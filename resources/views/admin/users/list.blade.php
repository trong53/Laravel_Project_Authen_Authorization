...
@section('title', 'Users\'s Management')

@section('content')
    <!-- Page Heading -->
    <h1 class="h3 mb-0 text-gray-800 text-center">Listing of Users</h1>
    ...
    <p>
        <a href="{{route('admin.users.add')}}" class="btn btn-primary"> Add an user </a>
    </p>
    @endcan
    ...
    <table class="table table-bordered table-hover">
        ...
        <tbody>
            @if ($userList->count() > 0)
                @foreach ($userList as $key=>$user)
                    <tr>
                        ...
                        <td>
                            {{-- @can('update', $user) --}}
                            <a href="{{route('admin.users.edit', [$user])}}" class="btn btn-warning mx-auto"> Modify </a>
                            {{-- @else
            ...
            @else
                <tr>
                    <td colspan="7"> <h3 class="text-center my-5"> There is no user </h3> </td>
                </tr>
            @endif
